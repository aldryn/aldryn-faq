...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LatestQuestionsPlugin.cache_duration'
        db.add_column(u'aldryn_faq_latestquestionsplugin', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MostReadQuestionsPlugin.cache_duration'
        db.add_column(u'aldryn_faq_mostreadquestionsplugin', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TopQuestionsPlugin.cache_duration'
        db.add_column(u'aldryn_faq_topquestionsplugin', 'cache_duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LatestQuestionsPlugin.cache_duration'
        db.delete_column(u'aldryn_faq_latestquestionsplugin', 'cache_duration')

        # Deleting field 'MostReadQuestionsPlugin.cache_duration'
        db.delete_column(u'aldryn_faq_mostreadquestionsplugin', 'cache_duration')

        # Deleting field 'TopQuestionsPlugin.cache_duration'
        db.delete_column(u'aldryn_faq_topquestionsplugin', 'cache_duration')
    ...
    models = {
        ...
        u'aldryn_faq.latestquestionsplugin': {
            ...
            'cache_duration': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
