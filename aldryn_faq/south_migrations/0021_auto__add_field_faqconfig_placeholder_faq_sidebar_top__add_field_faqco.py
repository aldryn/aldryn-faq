...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FaqConfig.placeholder_faq_sidebar_top'
        db.add_column(u'aldryn_faq_faqconfig', 'placeholder_faq_sidebar_top',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_faq_sidebar_top', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'FaqConfig.placholder_faq_sidebar_bottom'
        db.add_column(u'aldryn_faq_faqconfig', 'placholder_faq_sidebar_bottom',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_faq_sidebar_bottom', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'FaqConfig.placholder_faq_content'
        db.add_column(u'aldryn_faq_faqconfig', 'placholder_faq_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_faq_content', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'FaqConfig.placholder_faq_list_top'
        db.add_column(u'aldryn_faq_faqconfig', 'placholder_faq_list_top',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_faq_list_top', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'FaqConfig.placholder_faq_list_bottom'
        db.add_column(u'aldryn_faq_faqconfig', 'placholder_faq_list_bottom',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_faq_list_bottom', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FaqConfig.placeholder_faq_sidebar_top'
        db.delete_column(u'aldryn_faq_faqconfig', 'placeholder_faq_sidebar_top_id')

        # Deleting field 'FaqConfig.placholder_faq_sidebar_bottom'
        db.delete_column(u'aldryn_faq_faqconfig', 'placholder_faq_sidebar_bottom_id')

        # Deleting field 'FaqConfig.placholder_faq_content'
        db.delete_column(u'aldryn_faq_faqconfig', 'placholder_faq_content_id')

        # Deleting field 'FaqConfig.placholder_faq_list_top'
        db.delete_column(u'aldryn_faq_faqconfig', 'placholder_faq_list_top_id')

        # Deleting field 'FaqConfig.placholder_faq_list_bottom'
        db.delete_column(u'aldryn_faq_faqconfig', 'placholder_faq_list_bottom_id')
    ...
    models = {
        ...
        u'aldryn_faq.faqconfig': {
            ...
            'placholder_faq_content': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'aldryn_faq_content'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
            'placholder_faq_list_bottom': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'aldryn_faq_list_bottom'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
            'placholder_faq_list_top': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'aldryn_faq_list_top'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
            'placholder_faq_sidebar_bottom': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'aldryn_faq_sidebar_bottom'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
