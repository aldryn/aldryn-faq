...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionTranslation.slug'
        db.add_column(u'aldryn_faq_question_translation', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FaqConfig.permalink_type'
        db.add_column(u'aldryn_faq_faqconfig', 'permalink_type',
                      self.gf('django.db.models.fields.CharField')(default=u'Ss', max_length=2),
                      keep_default=False)

        # Adding field 'FaqConfig.non_permalink_handling'
        db.add_column(u'aldryn_faq_faqconfig', 'non_permalink_handling',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=302),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionTranslation.slug'
        db.delete_column(u'aldryn_faq_question_translation', 'slug')

        # Deleting field 'FaqConfig.permalink_type'
        db.delete_column(u'aldryn_faq_faqconfig', 'permalink_type')

        # Deleting field 'FaqConfig.non_permalink_handling'
        db.delete_column(u'aldryn_faq_faqconfig', 'non_permalink_handling')
